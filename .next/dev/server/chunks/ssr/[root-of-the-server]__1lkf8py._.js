...
const logger = __importStar(__turbopack_context__.r("[project]/node_modules/gcp-metadata/node_modules/google-logging-utils/build/src/index.js [app-rsc] (ecmascript)"));
...
"[project]/node_modules/gcp-metadata/node_modules/google-logging-utils/build/src/colours.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/gcp-metadata/node_modules/google-logging-utils/build/src/index.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
__exportStar(__turbopack_context__.r("[project]/node_modules/gcp-metadata/node_modules/google-logging-utils/build/src/logging-utils.js [app-rsc] (ecmascript)"), exports);
}),
"[project]/node_modules/gcp-metadata/node_modules/google-logging-utils/build/src/logging-utils.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const colours_1 = __turbopack_context__.r("[project]/node_modules/gcp-metadata/node_modules/google-logging-utils/build/src/colours.js [app-rsc] (ecmascript)");
...
const types_1 = __turbopack_context__.r("[project]/node_modules/google-logging-utils/build/src/types.js [app-rsc] (ecmascript)");
// Some functions (as noted) are based on the Node standard library, from
// the following file:
//
// https://github.com/nodejs/node/blob/main/lib/internal/util/debuglog.js
...
"[project]/node_modules/google-logging-utils/build/src/types.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const pkg = __turbopack_context__.r("[project]/node_modules/googleapis-common/package.json.[json].cjs [app-rsc] (ecmascript)");
...
__exportStar(__turbopack_context__.r("[project]/node_modules/googleapis-common/build/src/util.js [app-rsc] (ecmascript)"), exports);
}),
...
"[project]/node_modules/googleapis-common/package.json.[json].cjs [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/youtube-transcript-plus/dist/youtube-transcript-plus.mjs [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** Thrown when YouTube is rate-limiting requests from your IP address. */ class YoutubeTranscriptTooManyRequestError extends Error {
    constructor(){
...
/** Thrown when the requested video is unavailable or has been removed. */ class YoutubeTranscriptVideoUnavailableError extends Error {
    constructor(videoId){
...
/** Thrown when transcripts are disabled for the video by its owner. */ class YoutubeTranscriptDisabledError extends Error {
    constructor(videoId){
...
/** Thrown when no transcripts are available for the video. */ class YoutubeTranscriptNotAvailableError extends Error {
    constructor(videoId){
...
/** Thrown when the transcript is not available in the requested language. */ class YoutubeTranscriptNotAvailableLanguageError extends Error {
...
/** Thrown when the provided `lang` option is not a valid BCP 47 language code. */ class YoutubeTranscriptInvalidLangError extends Error {
    constructor(lang){
...
/** Thrown when the provided video ID or URL is invalid. */ class YoutubeTranscriptInvalidVideoIdError extends Error {
    constructor(){
...
/** Returns true if the HTTP status code is retryable (429 or 5xx). */ function isRetryableStatus(status) {
 ...
 */ class FsCache {
     ...
     */ constructor(cacheDir = './cache', defaultTTL = DEFAULT_CACHE_TTL){
        ...
        this.ready = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(cacheDir, {
            recursive: true
        }).then(()=>{});
    }
    get(key) {
        return __awaiter(this, void 0, void 0, function*() {
            yield this.ready;
            const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(this.cacheDir, sanitizeKey(key));
            try {
                const data = yield __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["default"].readFile(filePath, 'utf-8');
                const { value, expires } = JSON.parse(data);
                if (expires > Date.now()) {
                    return value;
                }
                yield __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["default"].unlink(filePath);
            } catch (_error) {}
            return null;
        });
    }
    set(key, value, ttl) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            yield __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(filePath, JSON.stringify({
                value,
                expires
            }), 'utf-8');
        });
 ...
 * ```
 */ class InMemoryCache {
    /** @param defaultTTL - Default time-to-live in milliseconds. Defaults to 1 hour. */ constructor(defaultTTL = DEFAULT_CACHE_TTL){
        this.cache = new Map();
        this.defaultTTL = defaultTTL;
    }
    get(key) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1lkf8py._.js.map